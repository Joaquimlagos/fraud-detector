...
public class TransactionController {
    ...
    @GetMapping("/{transactionId}/analysis")
    @Operation(summary = "Returns the fraud analysis result for a transaction")
    public ResponseEntity<TransactionAnalysisResponseDTO> findAnalysis(@PathVariable String transactionId) {
        return ResponseEntity.ok(transactionService.findAnalysis(transactionId));
    }
}